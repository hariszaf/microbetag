...
\label{sec:background}
    ...
    Their inference inherits the challenges of metagenomic data analysis (e.g., compsitionality, parameters inference)~\cite{cao2017inferring}.
...
\label{sec:implementation}
    ...
    \label{subsec:preprocess}
        ...
        In order to aid the user to map their sequences to the GTDB taxonomy, DADA2-formatted 16S rRNA gene sequences for both bacteria and archaea~\cite{ali_alishum_2022_6655692} were used to trained the TAXID classifier of the DECIPHER package~\cite{{murali2018idtaxa}} and are available through the~\href{https:/hub.docker.com/repository/docker/hariszaf/microbetag_prep/}{microbetag preprocess Docker image}.
    ...
    \label{subsec:seeds}
        ...
        In the framework of \microbetag, seed scores were computed using GENREs derived from the high quality GTDB representative genomes and the~\texttt{PhyloMint} tool.
    ...
    \label{subsec:groups}
        ...
        1. the lifestyle of a species, for example being halophilic or thermophyllic etc.,
        2. the biogeochemical processes a species metabolic potenial has been found related to, for example Nitrite-oxidizing bacteria (NOB) bacteria and 
        3. important metabolites a species is suggested to produce, e.g. butanol.
        Aim of these groups are to facilitate filtering of the taxa present.
        Enrichemnt analysis for members of such groups 
        (e.g., based on the finfings of a clustering algorithm like \texttt{manta}) 
...
\label{sec:results}
    ...
    \label{subsec:validation}
        ...
        supplementary file~\ref{suppl:valAnnotNet}
        ...
        Thiamine alternative pathway~\cite{llavero2022thiamine, romine2017underlying}~\footnote{to understand our findings}
        ...
        % Table for Variovorax - thiamine and neighbors
        \begin{table}[ht]
        \begin{minipage}{\linewidth}
            \begin{adjustbox}{width=1.3\textwidth,center=\textwidth}
                \begin{tabular}{c|c}
                    ...
                    \end{tabular} &
                    \begin{tabular}{ccc}
                        \multicolumn{3}{c}{B. Neighbors thiamine-related benefits among them } \\
                        \toprule
                        \thead{Beneficiary} & \thead{Donor} & \thead{potential complement} \\
                        \toprule
                        \textit{T. ferruginea} & Tahibacter & C01081 \\
                        \textit{T. ferruginea} & Rhodoglobus & C01081 \\
                        Nitrosospira & Bosea sp001898115 & C04327;C01279 \\
                        Chloroflexi & Bosea sp001898115 & C15809 \\
                        Chloroflexi & Xanthobacteraceae & C15809 \\
                        Chloroflexi & Nitrosospira & C15809 \\
                    \end{tabular} \\
                \end{tabular} \\
            \end{adjustbox}
            \caption{
    ...
    \end{table}
        ...
        Regarding pantothenate, the Variovorax genome mapped from GTDB-tk \(GCA\_001899795.\)
        brings two complete KEGG modules for that....

        \>\>\> a["md:M00119"] \\
        \{'0': 'K01918', '1': 'K00826', '2': 'K00077', '3': 'K00606'\} \\
        \>\>\> a["md:M00913"] \\
        \{'0': 'K01918', '1': 'K00077', '2': 'K00128', '3': 'K00606'\} \\
        ...
        \begin{figure}[h!]
            \includegraphics*[width=0.8\columnwidth]{figs/cyPanels.png}
            \centering
            \caption{
...
\label{sec:discussion}
    ...
    \label{subsec:resource}
        ...
        Distribution of the complements among taxa // su

...
\abstract{
    ...
    \begin{figure}[H]
        ...
        \caption*{
            ...
            % integrating 
            % genomic data 
            Figure built on \href{https://excalidraw.com}{excalidraw} 
        }
    \end{figure}
...
\section{Implementation}~\footnote{This should include a description of the overall architecture of the software implementation, along with details of any critical issues and how they were addressed.}
    ...
    \subsection*{ Genomes retrieval and annotation }
        ...
        % we retrieved the NCBI genome accessions of
    ...
    \subsection*{ Network inference }
        ...
        microbetag builds a co-occurrence network on the fly using FlashWeave~\cite{flashweave_cite} in case one is not provided by the user.
        The user may set most of its arguments through the microbetag interface or for total control of the software they can edit the corresponding script throught the microbetag preprocessing Docker image.
        In case a network is already available, the user may use it by either loading it through the CytoscapeApp (all networks formats supported) or through the CLI (\texttt{.cyjson} format supported).
...
\section{Results}
    ...
    \subsection*{microbetag and microbetagDB}
        ...
        \begin{figure}[H]
            ...
            \includegraphics[width=\columnwidth]{figs/microbetag-wf-precalc2.png}
        \end{figure}

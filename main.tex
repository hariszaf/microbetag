...
\begin{appendices}
    ...
    \label{app:pathcompl}
        ...
        When the non-seed set of a genome (donor) provided a seed related to a KEGG module to another genome (beneficiary) was considered potential metabolic interaction.

...
\label{sec:background}
    ...
    % Bacteria may complement each other not only for getting what is absolutely necessary for them to survive (seeds).
    ...
    % genome annotations combined with collections of functional units to highlight can provide a valid proxy
...
\label{sec:implementation}
    ...
    \label{subsec:build-cytoapp}
        ...
        Last, 
        MGG 
        % supports enrichment analysis 
        allows
        % of the network's modes based on 

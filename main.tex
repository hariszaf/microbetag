...
\label{sec:implementation}
    ...
    \label{subsec:seeds}
        ...
        Most recently, the~\texttt{PhyloMint}tool~\cite{phylomint_ms} was released supporting the calculation of the seed scores of GENREs in SBML format.

        In the framework of microbetag, seed scores were computed using \texttt{PhyloMint} and draft GENREs for all pair-wised combinations of GTDB representative genomes that have been RAST annotated in the framework of the PATRIC database~\cite{wattam2017improvements}.

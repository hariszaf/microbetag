...
for filename in os.listdir("../../ref-dbs/gtdb_genomes/all_kofam_scan/"):
...
for line in metadata_file: 
	...
	# replace all_kofam_scan with ko_annotations  
        ncbi_path = os.path.join("../../ref-dbs/gtdb_genomes/all_kofam_scan/", ncbi_taxonomy_id)

        if os.path.isdir(ncbi_path) == False:
            os.mkdir(ncbi_path)

        faa_file        = "../../ref-dbs/gtdb_genomes/all_kofam_scan/" + accession_files[ncbi_genome_accession_id]
        kegg_annot_file = "../../ref-dbs/gtdb_genomes/all_kofam_scan/" + str(ncbi_taxonomy_id) + "/" + accession_files[ncbi_genome_accession_id]

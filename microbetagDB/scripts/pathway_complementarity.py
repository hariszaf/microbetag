...
KO_ANNOTATED_GENOMES_FILS        = os.path.join(microbetagDB_path, "ref-dbs/ko_per_mod_in_genome_per_ncbiId.json")
...
def build_kegg_url():
   ...
   maps = open( os.path.join(microbetagDB_path, "mappings/kegg_mappings/module_map_pairs.tsv"), "r")
   module_map = {}
   for line in maps:
         ...
         for module, alternative_paths in complPath_gaps.items():
            ...
            for path, missing_kos in alternative_paths.items():
               ...
               if check:
                  ...
                  tab_file_writer.writerow([beneficiary_genomeId, donors_genomeId, beneficiary_ncbi_id, donor_ncbi_id, module, ";".join(missing_kos), ";".join(clean_path)])
...
if __name__ == "__main__": 
   ...
   ko_annotated_genomes_per_ncbiId = open(KO_ANNOTATED_GENOMES_FILS, "r")

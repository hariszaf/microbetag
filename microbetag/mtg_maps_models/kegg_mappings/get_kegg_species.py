...
for line in kegg_species:
    ...
    kos_related_to_mos_path = (
        cwd + "/kegg_genomes/" + ncbi_id + "/" + kegg_id + "_kos_related_to_mos.tsv"
    )
    kos_related_to_mos_json = (
        cwd + "/kegg_genomes/" + ncbi_id + "/" + kegg_id + "_kos_related_to_mos.json"
    )
        ...
        if species_ko in species_modules.keys():
            ...
            for module in species_modules[species_ko]:
                ...
                if kegg_module not in species_kos_per_module:
                    ...
                    species_kos_per_module[kegg_module][
                        str(len(species_kos_per_module[kegg_module]))
                    ] = kegg_ko[:-1]
